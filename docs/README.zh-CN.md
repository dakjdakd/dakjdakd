...
参与红树林底栖生物识别相关数据与模型工作，清理、归一化并标注了大量数据，涵盖 10 个红树林底栖生物类别。

## 内容与个人品牌

我也围绕 AI 工具、项目实践、视觉表达和产品探索进行内容实验，把技术理解转化成更容易被理解和传播的内容。

- 木沐玩偶 / MuMu: AI 工具、内容设计和项目表达
- 小淋设计师 / XiaoLin Designer: 视觉设计、IP 头像和内容包装
- 1k+ 粉丝 · 10k+ 点赞与收藏 · 真实内容和产品反馈
...
请前往[联系方式](./contact.md)查看 GitHub、Portfolio、邮箱和微信。
